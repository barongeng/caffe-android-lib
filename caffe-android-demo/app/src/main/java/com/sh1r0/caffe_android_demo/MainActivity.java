...
public class MainActivity extends Activity implements CNNListener {
    ...
    String modelDir = sdcard.getAbsolutePath() + "/caffe_mobile/bvlc_googlenet";
    String modelProto = modelDir + "/deploy.prototxt";
    String modelBinary = modelDir + "/bvlc_googlenet.caffemodel";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (file.exists())
        caffeMobile.loadModel(modelProto, modelBinary, 0);
    ...
    private class CNNTask extends AsyncTask<String, Void, Integer> {
        ...
        protected Integer doInBackground(String... strings) {
            ...
            int[] predict = caffeMobile.predictImage(strings[0]);
            if (predict == null || 0 == predict.length)
                return -1;
            else
                return predict[0];
        }
    ...
    public void onTaskCompleted(int result) {
        ...
        if(result >=0)
            ...
            tvLabel.setText("No thing recongnized !");
        btnCamera.setEnabled(true);
        btnSelect.setEnabled(true);
