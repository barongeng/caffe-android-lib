...
IF(NOT ViennaCL_INCLUDE_DIR)
	SET(ViennaCL_INCLUDE_DIR ${VIENNACL_HOME})
ENDIF()
...
IF(NOT ViennaCL_INCLUDE_DIR)
	...
	MESSAGE(STATUS "Viennacl path: ${VIENNACL_INCLUDE_SEARCH_PATHS}")
    MESSAGE(STATUS "VIENNACL_HOME: ${VIENNACL_HOME}")
ENDIF()
...
MESSAGE(STATUS "ViennaCL Libs: ${ViennaCL_LIBRARIES}")
